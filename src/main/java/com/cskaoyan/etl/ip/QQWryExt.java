 ...
 *
 */
public class QQWryExt extends QQWry{
    private RegionInfo DEFAULT_INFO = new RegionInfo();

    public QQWryExt() throws IOException {
    }

    public QQWryExt(byte[] data) {
        super(data);
    }

    public QQWryExt(Path file) throws IOException {
        super(file);
    }
    ...
    public static class RegionInfo {
        public static final String DEFAULT_VALUE = "未知"; // 默认值
