...
import com.cskaoyan.count.province.output.DBOutputFormat;
...
public class ProvinceCount {
    public static void main(String[] args) throws IOException, InterruptedException, ClassNotFoundException {
        ...
        //任务加载类
        job.setJarByClass(ProvinceCount.class);
        //任务名
        job.setJobName("Province Count");
        ...
        job.setOutputKeyClass(ProvinceSummary.class);
        ...
        //reduce类型
        job.setReducerClass(ProvinceCountReducer.class);
